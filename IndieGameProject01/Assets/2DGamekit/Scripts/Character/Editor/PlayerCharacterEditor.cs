...
namespace Gamekit2D
{
    ...
    public class PlayerCharacterEditor : UnityEditor.Editor
    {
        ...
        SerializedProperty m_FacingUpLeftBulletSpawnPointProp;
        SerializedProperty m_FacingUpRightBulletSpawnPointProp;
        SerializedProperty m_FacingUpBulletSpawnPointProp;
        ...
        readonly GUIContent m_FacingUpLeftBulletSpawnPointContent = new GUIContent("Facing UpLeft Bullet Spawn Point");
        readonly GUIContent m_FacingUpRightBulletSpawnPointContent = new GUIContent("Facing UpRight Bullet Spawn Point");
        readonly GUIContent m_FacingUpBulletSpawnPointContent = new GUIContent("Facing Up Bullet Spawn Point");
        ...
        void OnEnable ()
        {
            ...
            m_FacingUpLeftBulletSpawnPointProp = serializedObject.FindProperty("facingUpLeftBulletSpawnPoint");
            m_FacingUpRightBulletSpawnPointProp = serializedObject.FindProperty ("facingUpRightBulletSpawnPoint");
            m_FacingUpBulletSpawnPointProp = serializedObject.FindProperty("facingUpBulletSpawnPoint");
        ...
        public override void OnInspectorGUI ()
        {
            ...
            if (m_ReferencesFoldout)
            {
                ...
                EditorGUILayout.PropertyField (m_FacingUpLeftBulletSpawnPointProp, m_FacingUpLeftBulletSpawnPointContent);
                EditorGUILayout.PropertyField (m_FacingUpRightBulletSpawnPointProp, m_FacingUpRightBulletSpawnPointContent);
                EditorGUILayout.PropertyField (m_FacingUpBulletSpawnPointProp, m_FacingUpBulletSpawnPointContent);
