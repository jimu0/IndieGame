...
namespace Gamekit2D
{
    public class PlayerInput : InputComponent, IDataPersister
    {
        ...
        public InputButton MeleeAttack = new InputButton(KeyCode.Y, XboxControllerButtons.X);
        public InputButton RangedAttack = new InputButton(KeyCode.H, XboxControllerButtons.B);
        ...
        void Awake ()
        {
            if (s_Instance == null)
                ...
                throw new UnityException("不能有多个PlayerInput脚本.  实例如下 " + s_Instance.name + " 和 " + name + ".");
        }
